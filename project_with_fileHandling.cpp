...
string shoottypear[SIZE];
string package_ar[SIZE] ;
int hours[SIZE] ;
int userchoice;
string name;
...
void savedata(int index, string namearray[], string shoottypear[], string package_ar[], int hours[], int shoot_bill[])
{
...
void loaddata(int &index, string namearray[], string shoottypear[], string package_ar[], int hours[], int shoot_bill[])
{
    ifstream file("bookings.txt");
    while(getline(file, namearray[index]))
    {
        getline(file, shoottypear[index]);
        getline(file, package_ar[index]);
        file >> hours[index];
        file >> shoot_bill[index];
...
void addbooking(int &index, string namearray[], string shoottypear[], string package_ar[], int hours[], int shoot_bill[])
{
    ...
    index++;
    savedata(index, namearray, shoottypear, package_ar, hours, shoot_bill);
}
...
int main()
{
    loaddata(index, namearray, shoottypear, package_ar, hours, shoot_bill);
    while (true)
    {
        cout << "==============================================" << endl;
